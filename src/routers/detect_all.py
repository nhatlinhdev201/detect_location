...
from src.configs.mongodb_config import mongo_db
from concurrent.futures import ProcessPoolExecutor
import httpx
import json
import asyncio
from entities.address_entity import Address_3, AddressRequest
    ...
    if response.status_code == 200:
        try:
            ...
            if isinstance(data_list, list):
                ...
                if processed_data:
                    collection = await mongo_db.get_collection(COLLECTION_1)
